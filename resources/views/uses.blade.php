  ...
  <div class="mt-6 prose">
    ...
    <ul>
      <li>
        ...
        <p>An amazing cloud-hosting provider that offers many amazing additional services. Very easy to spin up a droplet to test out projects or software.</p>
      </li>
      <li>
        <a href="https://forge.laravel.com">Laravel Forge</a>
        <p>A complete life-saver; it makes it incredibly easy to maintain Laravel applications. Everything from databases to daemons can be managed on a web interface.</p>
      </li>
      <li>
      ...
      <li>
        ...
        <p>I've been through at least three other domain registrars; Hover is the only one with a clean UI and incredible customer support.</p>
      </li>
    </ul>
    ...
    <ul>
      <li>
        ...
        <p>I am adamant about putting every future event into my Calendar. Upcoming events are displayed on my phone and I never have to worry about missing anything. Even my college schedule is in here.</p>
      </li>
      <li>
        <a href="https://www.alfredapp.com">Alfred</a>
        <p>Did someone say productivity? Boy, does this program speed up your workflow. It's literally how I navigate on my Mac.</p>
      </li>
      <li>
